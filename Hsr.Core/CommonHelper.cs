...
namespace Hsr.Core
{
    ...
    public class CommonHelper
    {
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new CustomException("No property '{0}' found on the instance of type '{1}'.", propertyName,
                    instanceType);
            if (!pi.CanWrite)
                throw new CustomException("The property '{0}' on the instance of type '{1}' does not have a setter.",
