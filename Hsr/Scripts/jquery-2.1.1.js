...
(function (a) {
    a.fn.Message = function (b) {
        var c = { type: "error", time: 2000, text: "Error!", target: "#messages", click: true };
        var b = a.extend(c, b); var d = Math.ceil(Math.random() * 10000);
        return this.each(function() {
            ...
            a("#" + d).slideDown(function() {
                 setTimeout(function () { a("#" + d).slideUp(function () { a("#" + d).remove() }) }, b.time)
            });
            a(".click_close").click(function () { a(this).slideUp(function () { a(this).remove() }) })
